...
for(int k = 1; k <= n - 1; k++){
    ...
    for(int i = 0; i < current_tag_struct_num; i++){
        ...
        tag[i].tag_content = "";
            ...
            for(int i = uncomment_comment_num; i < user[user2_order].posts[uncomment_post_num-1].num_comments; i++){
            ...
            unsigned int unfollow_following;
            unsigned int unfollow_follower;
            for(unsigned int i = 0; i < user[user1_order].num_following; i++){
